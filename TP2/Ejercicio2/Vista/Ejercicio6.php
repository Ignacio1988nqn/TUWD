...
<head>
   ...
   <script src="/TUWD/TP2/Ejercicio2/Vista/assets/verificacion6_jquery.js"> </script>
  
</head>
<body>
    <form action="action/verdatos6.php" method="GET" id="form">  <!-- action: a donde se enviara el formulario (pag php)--> 
