...
<body>
    ...
    include_once 'C:/XAMPP/htdocs/TUWD/TP2/Ejercicio2/Control/Operacion.php';
    ...
    ?>
    <br>
    <a href="/TUWD/TP2/Ejercicio2/Vista/Ejercicio7.php" class="btn btn-primary">Volver al formulario</a>
    <br>
    <br>
