...
<div id="container" style="margin:50px 400px">
    <form id="form" class="row g-3 form-style" action="./action/ej4.php" enctype="multipart/form-data" method="post">
        <div class="col-md-6">
        ...
        <div class="col-md-8">
            <label for="guion" class="form-label" style="margin-left: 25px;">Restricción de edad</label>
